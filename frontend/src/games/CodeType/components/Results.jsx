...
export default function Results({ results, onPlayAgain, onGoHome }) {
  return (
    <motion.div
    ...
    >
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div className="card">
          ...
          <div className="text-3xl font-bold text-success">{results.cpm}</div>
          <div className="text-sm text-gray-400">CPM</div>
        </div>
        <div className="card">
          <Target className="w-8 h-8 text-cyan-400 mx-auto mb-2" />
          <div className="text-3xl font-bold text-cyan-400">{results.accuracy}%</div>
